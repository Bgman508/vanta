      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button onClick={() => setPlaying(!playing)} size="icon" className="bg-white text-black hover:scale-105 transition-transform">
          ...
          <div className="flex-1 flex items-center gap-3">
            ...
            <span className="text-xs text-neutral-500 w-12">{formatTime(180)}</span>
          </div>
